...
import os
import requests
from src.config.data.contratos.database_contratos import DatabaseContratosManager
...
class GerenciarInclusaoExclusaoContratos(QDialog):
    def __init__(self, synchronize_icon, database_path, parent=None):
        super().__init__(parent)
        self.synchronize_icon = synchronize_icon  # Ícone específico passado como parâmetro
    ...
    def init_ui(self):
        ...
        sync_icon_label.setPixmap(self.synchronize_icon.pixmap(80, 80))  # Usa o ícone diretamente
